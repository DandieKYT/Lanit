...
public class SearchPage {
   public SelenideElement
            wordQA = $x("//*[@name='q']"),
            searchIcon = $x("//*[contains(@class, 'search_header')]//*[contains(@class, 'search__icon')]"),
            responseSearchQA = $x("//font[contains(text(), 'К сожалению, на ваш поисковый запрос ничего не найдено.')]");
