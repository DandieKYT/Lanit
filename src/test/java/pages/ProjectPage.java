...
public class ProjectPage {
    public SelenideElement checkoutBankResult = $x("//*[contains(@class, 'projects-list__list')]/div/a"), showResult = $x("//span[text()='Показать']"), bankOption = $x("//*[@id='ui-id-2']"), openIndustry = $x("//*[@id='projects-list__industry-button']//*[contains(@class, 'ui-selectmenu-icon')]"), openProject = $x("//*[contains(@class, 'menu__list')]//a[text()='Проекты']");
