...
public class CareerPage {
    ...
    public SelenideElement
            checkOutResponseQA = $x("//p[contains(text(), 'Увы, по вашему запросу ничего не нашлось.')]"),
            inputQA = $x("//*[contains(@class, 'Textfield_textfield__ac936')]"),
            openCareer = $x("//*[contains(@class, 'menu__list')]//a[text()='Карьера']");
